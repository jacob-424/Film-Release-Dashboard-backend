...
class UserAccountDetailsRepository  {
    ...
    async insert(userId, firstName, lastName, address1, address2,
    ...
    async update(userId, firstName, lastName, address1, address2,
                 city, state, zipCode, phoneNumber, email) {
    ...
    async select(userId) {
        const sql = `SELECT id, user_id, first_name, last_name, address_1, address_2,
                            city, state, zip_code, phone_number, email
